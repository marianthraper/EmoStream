...
def run_flask_app():
    app.run(port=5001)  # Set port number here


# Process messages from Kafka and send them to the HTTP endpoint
def process_kafka_messages():
    endpoint_url = 'http://localhost:5001/receive_message'  # URL of the HTTP endpoint
    ...
    for message in consumer:
        ...
        print(f"Subscriber 1 received and posting message: {filtered_message}")
